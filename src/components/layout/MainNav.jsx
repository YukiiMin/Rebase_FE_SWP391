...
function MainNav({ isAdmin = false }) {
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16 md:h-20">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs font-medium uppercase tracking-wider text-white/70">NATIONAL VACCINATION SYSTEM</span>
              </div>
            </Link>
  ...
  // User version of Navigation (original MainNav)
  return (
    <header className="bg-blue-800 sticky top-0 z-50 w-full">
      {/* Main navigation */}
      <nav className="relative bg-blue-800 shadow-md">
