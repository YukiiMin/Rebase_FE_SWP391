...
function Diagnosis({ open, setIsOpen }) {
	const handleClose = () => {
		setIsOpen(false);
	};
			...
			<Modal show={open} onHide={handleClose} size="xl">
				<Form>
					...
					<Modal.Body>
						...
						<Table striped bordered hover responsive>
							...
							<tbody>
								<tr>
									...
									<td>
										<Form.Group className="mb-3" controlId="description">
											<Form.Control as="textarea" rows={1} placeholder="Enter child reaction" name="description" />
										</Form.Group>
									</td>
								</tr>
							</tbody>
						...
						<Form.Group className="mb-3" controlId="description">
							<Form.Label>Recommended Vaccines</Form.Label>
							<Form.Control as="textarea" rows={3} placeholder="Enter recommended vaccines" name="description" />
						</Form.Group>
					</Modal.Body>
					<Modal.Footer>
